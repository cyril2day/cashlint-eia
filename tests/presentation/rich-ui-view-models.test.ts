...
describe('rich UI view models', () => {
  it('maps summary data into a rich home model with navigation, controls, caveats, and trace', () => {
    const viewModel = mapSummaryToRichHomeViewModel(summary)
